package sid.cycles.cycles.common.apertiumV2;
...
public class GetDataV2 {	
	...
	public static Context getContext(String root, String lang1, String lang2) {		
		...
		//System.out.print("[" + Arrays.toString(pairs_uniq_toString.toArray())); -> removed this stdout print for REST Api creation
		//System.out.println(", " + Arrays.toString(uniq.toArray()) + "]");		---> removed this stdout print for REST Api creation
	...
	public static void createLexiconFile(String lang){
		String outputFile = "data/lexica/lexicon-" + lang + ".txt";
		try {
